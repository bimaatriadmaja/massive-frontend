      ...
      <main id="content">
        <section class="berry-page-container">
          ...
          <div className="isi-2" style={{marginTop:'20px', marginLeft:'-10px'}}>
            ...
            The Gym in the Early Years: Starting Your<br/>
Health and Fitness Journey on the Right Point
            </h1>
            <div class="berry-author">By Wavi</div>
            <img
              loading="lazy"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/1b8ecd9934752294da1a07adc873b052495a3080757a4615686d95bb6bb73822?apiKey=828441a8e65f4aacaee2ce94caf37306&"
          ...
          At the start of every year, there is a surge in people's interest in starting a health and fitness journey, and one of the most popular places is the gym. When entering the gym at the start of the year, an important first step is to set clear goals. Whether it is to lose weight, increase muscle strength, or improve heart condition, having a clear goal will help design an appropriate exercise program.
            <br />
            <br />
            
Consulting with a trainer or instructor at the gym is a wise step to help design the right program according to each individual's abilities and goals. Apart from training at the gym, it is also important to pay attention to nutrition and diet. A balanced diet and proper nutrition support the overall fitness journey. However, consistency and discipline are the main keys to achieving health and fitness goals. Despite the crowds in the gym at the start of the year, the challenge is actually to stay consistent throughout the year. Giving the body adequate rest and recovery is also important, as overtraining can lead to injury and excessive fatigue. With the right approach and awareness of the importance of consistency, nutrition and recovery, starting your fitness journey early in the year can be a positive step towards a healthier and happier lifestyle.
            <br />
            <br />
          </article>
        </section>
                ...
                <div className="div-text-2">
                  ...
                  <div className="column-text-2">
                    <div className="div-text-8">
                      ...
                      The Health Benefits of Tennis:<br/>
