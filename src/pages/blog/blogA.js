...
function BlogA() {
  return (
    <div id="wrapper">
      <div
        id="banner-content"
        className="row clearfix animate__animated animate__fadeInLeft animate__delay-0.5s"
        style={{
        ...
        >
          ...
          >
            <div className="articles10">
              ...
              <div
                className="articles10"
                data-aos="fade-up"
                data-aos-delay="600"
              >
                <div className="articles-40">
                  <div className="column-articles10" data-aos="fade-right">
                  ...
                  >
                    <div className="articles-9">
                      ...
                      <div className="articles-11">By Bima</div>
                    </div>
