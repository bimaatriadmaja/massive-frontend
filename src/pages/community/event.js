    ...
    <section className="event-content-section">
      <section className="event-feed-section">
        ...
        <div className="event-feed-content">
          ...
          <div className="event-see-other-events" tabIndex="0" role="button">
            SEE OTHER EVENTS
          </div>
        </div>
      </section>
      <section className="event-title-wrapper">
      ...
      <section className="event-action-wrapper">
        <div className="event-half-width">
      ...
      <section className="event-additional-event-wrapper">
        <div className="event-half-width">
      ...
      <section className="event-additional-image-section">
      ...
      <section className="event-additional-action-wrapper">
        <div className="event-half-width">
